...
* 😃 Thank You! 😃
#+reveal_html: <div class="column" style="float:left; width: 50%;font-size: 75%">
#+attr_reveal: :frag (appear)
+ Emacs can supercharge *_your workflow_*
+ Percieved Barriers
  #+attr_reveal: :frag (appear)
  + [[color:red][Windows]]? 90% of what I've shown works! ✌️
    + Not all roses though 😬
  + [[color:red][Time investment]]? Ask Jan! 😸
